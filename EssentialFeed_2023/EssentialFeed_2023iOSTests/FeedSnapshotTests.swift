...
class FeedSnapshotTests: XCTestCase {
    ...
    func test_emptyFeed() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone(style: .light)), named: "EMPTY_FEED_dark")
    }
    ...
    func test_feedWithContent() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone(style: .light)), named: "FEED_WITH_CONTENT_dark")
    }
    ...
    func test_feedWithErrorMessage() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone(style: .light)), named: "FEED_WITH_ERROR_MESSAGE_dark")
    }
    ...
    func test_feedWithFailedImageLoading() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone(style: .light)), named: "FEED_WITH_FAILED_IMAGE_LOADING_dark")
    }
