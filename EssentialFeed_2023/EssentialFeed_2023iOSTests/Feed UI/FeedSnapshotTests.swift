...
class FeedSnapshotTests: XCTestCase {
    ...
    func test_feedWithFailedImageLoading() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone(style: .light, contentSize: .extraExtraExtraLarge)), named: "FEED_WITH_ERROR_MESSAGE_light_extraExtraExtraLarge")
        assert(snapshot: sut.snapshot(for: .iPhone(style: .dark, contentSize: .extraExtraExtraLarge)), named: "FEED_WITH_ERROR_MESSAGE_dark_extraExtraExtraLarge")
    }
    
    func test_feedWithLoadMoreIdicator() {
        let sut = makeSUT()
        
        sut.display(feedWithLoadMoreIdicator())
        
        assert(snapshot: sut.snapshot(for: .iPhone(style: .light)), named: "FEED_WITH_LOAD_MORE_IDICATOR_light")
        assert(snapshot: sut.snapshot(for: .iPhone(style: .dark)), named: "FEED_WITH_LOAD_MORE_IDICATOR_dark")
    }
    ...
    private func feedWithLoadMoreIdicator() -> [CellController] {
