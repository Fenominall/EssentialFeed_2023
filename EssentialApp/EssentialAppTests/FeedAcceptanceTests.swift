...
class FeedAcceptanceTests: XCTestCase {
    func test_onLaunch_displaysRemoteFeedWhenCustomerHasConnectivity() {
        ...
        XCTAssertNotNil(feed.renderedFeedImageData(at: 1))
        ...
        XCTAssertNotNil(feed.renderedFeedImageData(at: 0))
        XCTAssertNotNil(feed.renderedFeedImageData(at: 1))
        XCTAssertNotNil(feed.renderedFeedImageData(at: 2))
        XCTAssertTrue(feed.canLoadMoreFeed)
    ...
    func test_onLaunch_displaysCacheRemoteFeedWhenCustomerHasNoConnectivity() {
        ...
        XCTAssertNotNil(offlineFeed.renderedFeedImageData(at: 0))
        XCTAssertNotNil(offlineFeed.renderedFeedImageData(at: 1))
        XCTAssertNotNil(offlineFeed.renderedFeedImageData(at: 2))
    }
