...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadFeedActions_requestFeedFromLoader() {
        ...
        XCTAssertEqual(loader.loadFeedCallCount, 1, "Expected another loading request once user initiates a reload")
    ...
    func test_loadMoreActions_requestMoreFromLoader() {
        ...
        XCTAssertEqual(loader.loadMoreCallCount, 0, "Expected no loading request load more action")
    ...
    func test_loadingMoreIndicator_isVisibleWhileLoadingFeed() {
        let (sut, loader) = makeSUT()
        
        sut.simulateAppearance()
        XCTAssertFalse(sut.isShowingLoadMoreFeedIndicator, "Expected no indicator once view appears")
    ...
    func test_loadFeedCompletion_rendersSuccessfullyLoadedEmptyFeedAfterNoEmptyFeed() {
